...
void memcpy_aptp2blkintl(double *arrayAblk, double **Ap2p, int n, int block_size, int batch_count) {
    int lda = n;
    int startpos;
    int offset;
...
void memcpy_ablkintl2ptp(double **Ap2p, double *arrayAblk, int n, int block_size, int batch_count) {
    int lda = n;
    int startpos;
    int offset;
    int numblocks = batch_count / block_size;
