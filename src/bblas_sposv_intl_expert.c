...
void bblas_sposv_intl_expert(enum BBLAS_UPLO uplo,
                             int m,
                             int n,
                             float *arrayA,
                             float *arrayB,
                             int batch_count, int info)
{
    ...
    bblas_strsm_intl_expert(CblasLeft, CblasLower, CblasNoTrans, CblasNonUnit,
                            m, n, alpha, arrayA, arrayB,
                            batch_count, info);

    //Solve U'*X = B, overwriting B with X.
    bblas_strsm_intl_expert(CblasLeft, CblasLower, CblasTrans, CblasNonUnit,
                            m, n, alpha, arrayA, arrayB,
                            batch_count, info);
      info = BBLAS_SUCCESS;
}
